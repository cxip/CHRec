...
//	private static final Uri API_URL=Uri.parse("http://192.168.0.51:8080/");
	...
	private final WorkerThread apiThread;
	private final Gson gson=new GsonBuilder().setDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSSZ").disableHtmlEscaping().setFieldNamingPolicy(FieldNamingPolicy.LOWER_CASE_WITH_UNDERSCORES).create();
	...
	private class RequestRunnable<T> implements Runnable{
		private final ClubhouseAPIRequest<T> req;
